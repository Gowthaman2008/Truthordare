...
export class QuestionEngine {
    ...
    getRandomQuestion(type, settings, usedQuestionIds, customQuestions = []) {
        ...
        if (settings.categories && settings.categories.length > 0) {
            const catFiltered = pool.filter(q => settings.categories.some(c => q.category.toLowerCase().includes(c.toLowerCase()) ||
